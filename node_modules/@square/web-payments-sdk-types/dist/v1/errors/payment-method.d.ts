 ...
 * ```
 */
export declare class PaymentMethodAlreadyAttachedError extends SqError {
 ...
 * ```
 */
export declare class PaymentMethodNotAttachedError extends SqError {
    constructor(paymentMethod: string);
}
/**
 ...
 * ```
 */
export declare class PaymentMethodAlreadyDestroyedError extends SqError {
    constructor(paymentMethod: string);
}
/**
 ...
 * ```
 */
export declare class InvalidElementTypeError extends SqError {
 ...
 * ```
 */
export declare class InvalidElementPresentError extends SqError {
