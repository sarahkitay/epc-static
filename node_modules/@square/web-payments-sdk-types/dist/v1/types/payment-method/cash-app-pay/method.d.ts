import type { PaymentMethod, SqEvent } from '../payment-method-types';
import type { CashAppPayButtonOptions, CashAppPayEventType, CashAppPayEventData } from './types';
/**
 ...
 * ```
 */
export interface CashAppPay extends PaymentMethod {
    /**
     ...
     * ```
     * @throws {@link PaymentMethodAlreadyDestroyedError} Cash App Pay was already destroyed
     * @throws {@link PaymentMethodNotAttachedError} Cash App Pay was not attached
     * @throws {@link CashAppPayInvalidShouldTokenizeError} Tokenize validation function threw an error
     * @throws {@link ElementNotFoundError} the provided DOM element could not be found
     * @throws {@link InvalidElementTypeError} the provided DOM element is the wrong type to use for attaching
     * @throws {@link InvalidCashAppPayOptionsFieldTypes} Cash App Pay button options has invalid types
     * @throws {@link InvalidCashAppPayOptionsFieldValues} Cash App Pay button options has invalid values
     */
     ...
     * ```
     * @throws {@link PaymentMethodAlreadyDestroyedError} `CashAppPay` has already been destroyed
     */
