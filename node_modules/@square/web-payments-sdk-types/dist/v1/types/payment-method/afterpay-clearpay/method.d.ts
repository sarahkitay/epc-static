 ...
 */
export interface AfterpayClearpay extends PaymentMethod {
    /**
     ...
     * @throws {@link PaymentMethodUnsupportedError} Afterpay/Clearpay is not available due to
     ...
     * @throws {@link ElementNotFoundError} Could not find the target element
     * @throws {@link InvalidElementTypeError} The target element is not a DIV or SPAN
     * @throws {@link PaymentMethodAlreadyDestroyedError} The payment method is already destroyed
     */
     ...
     * @throws {@link PaymentMethodMissingListener} A required event listener was not registered
     * @throws {@link AfterpayOnTokenizeListenerError} if both tokenize() and onTokenize listeners are set up
     * @throws {@link UnexpectedError} an internal SDK error occurred
     */
