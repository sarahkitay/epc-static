...
export interface GiftCard extends PaymentMethod {
     ...
     *
     * @throws {@link PaymentMethodAlreadyAttachedError} `GiftCard` is already attached to a DOM element
     ...
     * ```
     * @throws {@link PaymentMethodNotAttachedError} `GiftCard` is not attached to a DOM element
     * @throws {@link PaymentMethodAlreadyDestroyedError} `GiftCard` has already been destroyed
     * @throws {@link UnexpectedError} an internal SDK error occurred
     *
     */
     ...
     * ```
     * @throws {@link PaymentMethodNotAttachedError} `Gift card` is not attached to a DOM element
     * @throws {@link PaymentMethodAlreadyDestroyedError} `Gift card` has already been destroyed
     */
     ...
     * @throws {@link PaymentMethodNotAttachedError} `GiftCard` is not attached to a DOM element
     * @throws {@link PaymentMethodAlreadyDestroyedError} `GiftCard` has already been destroyed
     * @throws {@link TokenizationError} The giftCard could not be tokenized.
     */
