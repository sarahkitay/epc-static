 ...
 * ```
 */
export interface GooglePay extends PaymentMethod {
    /**
     ...
     *
     * @throws {@link PaymentMethodUnsupportedError} Google Pay is not available due to
     ...
     * ```
     * @throws {@link PaymentMethodAlreadyDestroyedError} `GooglePay` has already been destroyed
     * @throws {@link PaymentMethodNotAttachedError} `GooglePay` is not attached
     */
     ...
     * @throws {@link PaymentMethodUnsupportedError} Google Pay is not available due to
     * misconfiguration or non-support on this device or browser.
     * @throws {@link TokenizationError} The payment request could not be tokenized.
