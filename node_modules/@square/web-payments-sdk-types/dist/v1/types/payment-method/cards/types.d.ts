 ...
 * @internal
 */
export type StylePropertyList = Partial<Record<string, string>>;
/**
 * @internal
 */
export type ClassSelectors = Record<string, StylePropertyList>;
/**
 * @internal
 */
export type ClientClassSelectors = Partial<Record<string, StylePropertyList | ClassSelectors>>;
export declare const ALLOWED_INPUT_PROPERTIES: string[];
export declare const ALLOWED_COMPONENT_PROPERTIES: string[];
export declare const ALLOWED_COMPONENT_STATE_PROPERTIES: string[];
export declare const ALLOWED_INPUT_TEXT_PROPERTIES: string[];
export declare const ALLOWED_INPUT_ICON_PROPERTIES: string[];
export type InputPropertyValues = Partial<{
...
export type ComponentPropertyValues = Partial<{
    borderColor?: string;
    borderRadius?: string;
    /**
...
export type ComponentStatePropertyValues = Partial<{
    borderColor?: string;
    /**
...
export type InputTextPropertyValues = Partial<{
    color?: string;
}>;
/**
 ...
 * ```
 */
export interface CardClassSelectors extends ClientClassSelectors {
 ...
 * ```
 */
export interface CardInputEventState {
 ...
 * ```
 */
export interface CardInputEvent {
    cardBrand: string;
 ...
 */
export declare enum PrepaidType {
 ...
 * ```
 */
export interface ChargeCardVerificationDetails {
    /**
 ...
 * ```
 */
export interface StoreCardVerificationDetails {
    /**
     * Transactional intent of the payment.
     */
    intent: 'STORE';
