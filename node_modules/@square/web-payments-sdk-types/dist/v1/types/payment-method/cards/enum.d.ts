...
export declare enum CardInputEventTypes {
 ...
 */
export type CardInputEventTypesValues = `${CardInputEventTypes}`;
/** The four input field names in the payment card input form */
export declare enum CardFieldNames {
    /** Payment card number */
 ...
 */
export type CardFieldNamesValues = `${CardFieldNames}`;
/**
 * @internal
 *
 * Not currently exposed in our API
 */
export declare enum AllowedClassSelectors {
    CARD_INPUT = "input",
