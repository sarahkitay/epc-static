...
export interface Card extends PaymentMethod {
     ...
     * ```
     * @throws {@link PaymentMethodNotAttachedError} `Card` is not attached to a DOM element
     * @throws {@link PaymentMethodAlreadyDestroyedError} `Card` has already been destroyed
     ...
     *
     * @throws {@link ElementNotFoundError} the provided DOM element could not be found
     * @throws {@link InvalidElementTypeError} the provided DOM element is the wrong type
     * @throws {@link InvalidInputStylePropertyError} invalid style property provided
     * @throws {@link InvalidInputStyleSelectorError} invalid style CSS selector provided
     * @throws {@link InvalidInputStyleValueError} invalid style value provided
     * @throws {@link UnexpectedError} an internal SDK error occurred
     */
     ...
     * @throws {@link InvalidFieldNameError} the specified field name is invalid
     * @throws {@link PaymentMethodNotAttachedError} `Card` is not attached to a DOM element
     * @throws {@link PaymentMethodAlreadyDestroyedError} `Card` has already been destroyed
     */
     ...
     * });
     * ```
     * @throws {@link PaymentMethodNotAttachedError} `Card` is not attached to a DOM element yet.
     * @throws {@link PaymentMethodAlreadyDestroyedError} `Card` has already been destroyed.
     * @throws {@link TokenizationError} Tokenization of the payment card failed.
     */
