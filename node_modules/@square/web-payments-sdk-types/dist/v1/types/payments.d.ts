...
export interface Payments {
     ...
     * @throws {@link VerifyBuyerError} Something went wrong trying to verify the buyer
     */
     ...
     * @throws {@link InvalidPaymentRequestError} the provided payment request was invalid
     ...
     *
     * @throws {@link FeatureDisabledError} if the feature is not enabled for this application
     ...
     * });
     * ```
     * @throws {@link InvalidConfigurationPropertyError} if given invalid option properties
     * @throws {@link InvalidConfigurationValueError} if given invalid option values
     * @throws {@link WebSdkEmbedError} if the WebSDK is initialized in insecure context
     * @throws {@link UnexpectedError} an internal SDK error occurred
     */
     ...
     * @throws {@link InvalidElementPresentError} cannot build Google Pay due to the presence of a clashing DOM element
     * @throws {@link InvalidPaymentRequestError} the provided payment request was invalid
     * @throws {@link PaymentMethodUnsupportedError} the payment method was not supported for this merchant (See error message for reason)
     * @throws {@link WebSdkEmbedError} if the WebSDK is initialized in insecure context
     * @throws {@link UnexpectedError} an internal SDK error occurred
     */
     ...
     * @param paymentRequest - the payment request object created by [payments.paymentRequest(...)](https://developer.squareup.com/reference/sdks/web/payments/objects/Payments#Payments.paymentRequest)
     * @throws {@link InvalidPaymentRequestError} the provided payment request was invalid
     * @throws {@link PaymentMethodUnsupportedError} if Apple Pay is not supported here
     * @throws {@link WebSdkEmbedError} if the WebSDK is initialized in insecure context
     * @throws {@link UnexpectedError} an internal SDK error occurred
     */
     ...
     * @throws {@link AfterpayInvalidPaymentRequestError} if the provided payment request is invalid for Afterpay specifically
     * @throws {@link AfterpayRequestError} if there is a problem processing the payment request with Afterpay
     * @throws {@link InvalidCurrencyFormatError} if given invalid currency values
     * @throws {@link InvalidPaymentRequestError} the provided payment request was invalid
     * @throws {@link PaymentMethodUnsupportedError} the payment method was not supported for this merchant (See error message for reason)
     * @throws {@link WebSdkEmbedError} if the WebSDK is initialized in insecure context
     * @throws {@link UnexpectedError} an internal SDK error occurred
     ...
     * @param options
     * @throws {@link CashAppPayInvalidPaymentRequestError} the payment request was using an unsupported currency code
     * @throws {@link CashAppPayMissingRedirectUrlError} a redirect url was not provided.
     * @throws {@link PaymentMethodUnsupportedError} the payment method was not supported for this merchant (See error message for reason)
     * @throws {@link InvalidPaymentRequestError} the provided payment request was invalid
     * @throws {@link WebSdkEmbedError} if the WebSDK is initialized in insecure context
     * @throws {@link UnexpectedError} an internal SDK error occurred
