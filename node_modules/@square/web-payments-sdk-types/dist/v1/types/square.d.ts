...
export interface Square {
     ...
     *
     * @throws {@link InvalidApplicationIdError} The applicationID is invalid
     * @throws {@link ApplicationIdEnvironmentMismatchError} The applicationID does not
     * match the environment (sandbox/prod)
     * @throws {@link BrowserNotSupportedError} The browser is not supported
     * @throws {@link WebSdkEmbedError} The Web SDK instance cannot be embedded
     */
